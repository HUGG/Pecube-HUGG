      subroutine calculate_ages (nrec,nsurf,nz,istep,age1,age2,age3,age4,age5, &
...
!__________________________________________________________________________
      ...
      integer nsurf,nrec,nz,istep,i,ij,irec,k,ftlflag,ageflag(10)
      real*4 age1(nsurf),age2(nsurf),age4(nsurf),age5(nsurf),age3(nsurf) 
      real*4 age6(nsurf),age7(nsurf),age8(nsurf),raman(nsurf)
      ...
      if (.not.calc_surface_ages .and. PTt_output) open (71,file='TtPaths.txt',status='unknown')
      ...
      raman=0.
        ...
        ! the file is a three column ASCII file which contains time, temperature
        ! and depth

        if (.not.calc_surface_ages .and. PTt_output) then
...
! end of lines added to output Tt paths
        ...
        if (ageflag(10).eq.1) call calc_raman (ztemp,nrec,raman(i))
      ...
      if (.not.calc_surface_ages .and. PTt_output) close (71)
