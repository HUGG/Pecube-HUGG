      subroutine make_matrix (mpe,ael,bel,icon,xg,yg,zg,ug,xgp,ygp,zgp,ugp,    & !VTK
                              kfix,diffusivity,heatproduction,x1f,y1f,x2f,y2f, &
                              def,dif,alpha0,dt0,time,tempp,nnode,istatic,     &
                              fault,nfault,rebound,xming,xmaxg,yming,ymaxg,    &
                              friction,vxtopo,vytopo,vxtopo0)
...
! this is where the FE matrices and RHS vectors are built
      ...
      double precision r,s,t,w,vx,vy,vz,vxtopo,vytopo,vxtopo0
      ...
      timep=time-dt
        ...
        do i=1,mpe
        call find_velo (x(i),y(i),z(i),time,dt,fault,nfault,vv(i,1),vv(i,2),   &
                        vv(i,3),xming,xmaxg,yming,ymaxg,vxtopo,vytopo,vxtopo0)
        enddo
        ...
        call find_velo (xint,yint,zint,time,dt,fault,nfault,vx,vy,vz,xming,    &
                        xmaxg,yming,ymaxg,vxtopo,vytopo,vxtopo0)
